...
namespace Capa_Desconectada.NorthwindTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Customers] WHERE (([CustomerID] = @Original_CustomerID) AND ([CompanyName] = @Original_CompanyName) AND ((@IsNull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactName] = @Original_ContactName)) AND ((@IsNull_ContactTitle = 1 AND [ContactTitle] IS NULL) OR ([ContactTitle] = @Original_ContactTitle)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_PostalCode = 1 AND [PostalCode] IS NULL) OR ([PostalCode] = @Original_PostalCode)) AND ((@IsNull_Region = 1 AND [Region] IS NULL) OR ([Region] = @Original_Region)) AND ((@IsNull_Country = 1 AND [Country] IS NULL) OR ([Country] = @Original_Country)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Customers] ([CustomerID], [CompanyName], [ContactName], [ContactTitle], [Address], [City], [PostalCode], [Region], [Country], [Phone]) VALUES (@CustomerID, @CompanyName, @ContactName, @ContactTitle, @Address, @City, @PostalCode, @Region, @Country, @Phone);
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, PostalCode, Region, Country, Phone FROM Customers WHERE (CustomerID = @CustomerID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Customers] SET [CustomerID] = @CustomerID, [CompanyName] = @CompanyName, [ContactName] = @ContactName, [ContactTitle] = @ContactTitle, [Address] = @Address, [City] = @City, [PostalCode] = @PostalCode, [Region] = @Region, [Country] = @Country, [Phone] = @Phone WHERE (([CustomerID] = @Original_CustomerID) AND ([CompanyName] = @Original_CompanyName) AND ((@IsNull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactName] = @Original_ContactName)) AND ((@IsNull_ContactTitle = 1 AND [ContactTitle] IS NULL) OR ([ContactTitle] = @Original_ContactTitle)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_PostalCode = 1 AND [PostalCode] IS NULL) OR ([PostalCode] = @Original_PostalCode)) AND ((@IsNull_Region = 1 AND [Region] IS NULL) OR ([Region] = @Original_Region)) AND ((@IsNull_Country = 1 AND [Country] IS NULL) OR ([Country] = @Original_Country)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, PostalCode, Region, Country, Phone FROM Customers WHERE (CustomerID = @CustomerID)";
...
SET                CustomerID = @CustomerID, CompanyName = @CompanyName, ContactName = @ContactName, ContactTitle = @ContactTitle, Address = @Address, City = @City, PostalCode = @PostalCode, Region = @Region, 
...
";
        ...
        public virtual int Delete(string Original_CustomerID, string Original_CompanyName, string Original_ContactName, string Original_ContactTitle, string Original_Address, string Original_City, string Original_PostalCode, string Original_Region, string Original_Country, string Original_Phone) {
        ...
        public virtual int Insert(string CustomerID, string CompanyName, string ContactName, string ContactTitle, string Address, string City, string PostalCode, string Region, string Country, string Phone) {
            if ((CustomerID == null)) {
                throw new global::System.ArgumentNullException("CustomerID");
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_Country, 
                    string Original_Phone) {
            return this.Update(Original_CustomerID, CompanyName, ContactName, ContactTitle, Address, City, PostalCode, Region, Country, Phone, Original_CustomerID, Original_CompanyName, Original_ContactName, Original_ContactTitle, Original_Address, Original_City, Original_PostalCode, Original_Region, Original_Country, Original_Phone);
        }
        ...
        public virtual int ActualizarCliente(string CustomerID, string CompanyName, string ContactName, string ContactTitle, string Address, string City, string PostalCode, string Region, string Country, string Phone, string Original_CustomerID) {
            ...
            if ((Original_CustomerID == null)) {
                ...
                command.Parameters[10].Value = ((string)(Original_CustomerID));
            }
